...
public class SliderConstants {
    ...
    public static final String ALERT_SLIDER_PANEL_KEY = "alert_slider";
    public static final String ALERT_SLIDER_USAGE_KEY = "slider_usage";
    public static final String ALERT_SLIDER_ACTION_TOP_KEY = "action_top_position";
    public static final String ALERT_SLIDER_ACTION_MIDDLE_KEY = "action_middle_position";
    public static final String ALERT_SLIDER_ACTION_BOTTOM_KEY = "action_bottom_position";

    public static final String EXTRA_SLIDER_USAGE = "usage";
    public static final String EXTRA_SLIDER_ACTIONS = "actions";

    public static final String ALERT_SLIDER_FOR_NOTIFICATION = "1";
    public static final String ALERT_SLIDER_FOR_FLASHLIGHT = "2";
    public static final String ALERT_SLIDER_FOR_BRIGHTNESS = "3";
    public static final String ALERT_SLIDER_FOR_ROTATION = "4";
    public static final String ALERT_SLIDER_FOR_RINGER = "5";
    public static final String ALERT_SLIDER_FOR_NOTIFICATION_RINGER = "6";
    public static final String ALERT_SLIDER_FOR_EXTRADIM = "7";
    public static final String ALERT_SLIDER_FOR_NIGHTLIGHT = "8";
    public static final String ALERT_SLIDER_FOR_REFRESH = "9";
    public static final String ALERT_SLIDER_FOR_COLORSPACE = "10";
